...
var selectLoginData = createSelector(selectLogin, (state) => state.loginData);
...
function Login_For_18_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(x_r1.key);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(x_r1.value);
  }
}
function Login_ForEmpty_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275text(1, "No recods found");
    \u0275\u0275elementEnd();
  }
}
var Login = class _Login {
  ...
  store;
  loginForm;
  loginSignal = signal({}, ...ngDevMode ? [{ debugName: "loginSignal" }] : []);
  constructor(fb, toast, loginService, store) {
    this.fb = fb;
    this.toast = toast;
  ...
  onSubmit() {
    ...
    if (loginFormValue.username === "") {
      ...
      this.loginService.loginUser(__spreadProps(__spreadValues({}, loginFormValue), { expiresInMins: 30 })).subscribe((response) => {
  ...
  static \u0275fac = function Login_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _Login)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(ToasterService), \u0275\u0275directiveInject(LoginService), \u0275\u0275directiveInject(Store));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Login, selectors: [["app-login"]], features: [\u0275\u0275ProvidersFeature([KeyValuePipe])], decls: 21, vars: 4, consts: [[3, "ngSubmit", "formGroup"], ["type", "text", "formControlName", "username"], ["type", "password", "formControlName", "password"], ["type", "submit"]], template: function Login_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(6, "Please enter username");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(7, "div")(8, "label");
      \u0275\u0275text(9, "Password");
      \u0275\u0275elementEnd();
      \u0275\u0275element(10, "input", 2);
      \u0275\u0275elementStart(11, "small");
      \u0275\u0275text(12, "Please enter password");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(13, "div")(14, "button", 3);
      \u0275\u0275text(15, "Login");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(16, "div");
      \u0275\u0275repeaterCreate(17, Login_For_18_Template, 5, 2, "div", null, _forTrack0, false, Login_ForEmpty_19_Template, 2, 0, "div");
      \u0275\u0275pipe(20, "keyvalue");
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      ...
      \u0275\u0275advance(17);
      \u0275\u0275repeater(\u0275\u0275pipeBind1(20, 2, ctx.loginSignal()));
    }
  }, dependencies: [ReactiveFormsModule, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, KeyValuePipe], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Login, [{
    type: Component,
    args: [{ selector: "app-login", imports: [ReactiveFormsModule, KeyValuePipe], standalone: true, providers: [KeyValuePipe], template: '<form [formGroup]="loginForm" (ngSubmit)="onSubmit()">\n    <div>\n        <label>User name</label>\n        <input type="text" formControlName="username" />\n        <small>Please  enter username</small>\n    </div>\n      <div>\n        <label>Password</label>\n        <input type="password" formControlName="password" />\n         <small>Please  enter password</small>\n    </div>\n    <div>\n        <button type="submit">Login</button>\n    </div>\n</form>\n<div >\n@for(x of this.loginSignal() | keyvalue;track x.key){\n   <div>\n <div>{{x.key}}</div>\n    <div>{{x.value}}</div>\n   </div>\n   \n}@empty{\n    <div>No recods found</div>\n}\n</div>' }]
  }], () => [{ type: FormBuilder }, { type: ToasterService }, { type: LoginService }, { type: Store }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Login, { className: "Login", filePath: "src/app/features/login/login.ts", lineNumber: 18 });
})();
export {
  Login
};
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-IDB7MPQF.js.map
